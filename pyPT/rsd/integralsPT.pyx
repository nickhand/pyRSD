from pyPT.rsd cimport integral_base
from pyPT.cosmology cimport growth
from pyPT.cosmology.power import Power
...
class Integrals(object):
    ...
    def I_lin(self):
        try:
            ...
            self.__I_lin = integral_base.integral2D('f00', self.kmin_lin, self.kmax_lin, 
                                                    self.num_threads, 
                                                    self.klin, 
    ...
    def I_lin_vv1loop(self):
        try:
            ...
            self.__I_lin_vv1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                            self.num_threads, 
                                                            self.klin, 
                                                            self._power._unnormalized_P*NORM_FACTOR,
                                                            k2=self.k1loop, 
    ...
    def I_vv1loop(self):
        try:
            ...
            self.__I_vv1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                        self.num_threads, 
                                                        self.k1loop, 
                                                        self.Pvv_1loop,
                                                        k2=self.k1loop, 
    ...
    def I_lin_dd1loop(self):
        try:
            ...
            self.__I_lin_dd1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                            self.num_threads, 
                                                            self.klin, 
                                                            self._power._unnormalized_P*NORM_FACTOR,
                                                            k2=self.k1loop, 
    ...
    def I_dd1loop(self):
        try:
            ...
            self.__I_dd1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                            self.num_threads, 
                                                            self.k1loop, 
                                                            self.Pdd_1loop,
                                                            k2=self.k1loop, 
    ...
    def I_dd1loop_vv1loop(self):
        try:
            ...
            self.__I_dd1loop_vv1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                                self.num_threads, 
                                                                self.k1loop, 
                                                                self.Pdd_1loop,
                                                                k2=self.k1loop, 
    ...
    def I_lin_dv1loop(self):
        try:
            ...
            self.__I_lin_dv1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                            self.num_threads, 
                                                            self.klin, 
                                                            self._power._unnormalized_P*NORM_FACTOR,
                                                            k2=self.k1loop, 
    ...
    def I_dv1loop(self):
        try:
            ...
            self.__I_dv1loop = integral_base.integral2D('f00', self.kmin_1loop, self.kmax_1loop, 
                                                        self.num_threads, 
                                                        self.k1loop, 
                                                        self.Pdv_1loop,
                                                        k2=self.k1loop, 
    ...
    def J_lin(self):
        try:
            ...
            self.__J_lin = integral_base.integral1D('g00', self.kmin_lin, self.kmax_lin, 
                                                    self.klin, self._power._unnormalized_P*NORM_FACTOR)
            return self.__J_lin
