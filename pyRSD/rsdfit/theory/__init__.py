base_model_params = {'sigma8_z': 'mass variance at r = 8 Mpc/h at z',
                     ...
                     'b2_00_a' : 'the b2_00 nonlinear bias in Phm',
                     'b2_00_b' : 'the b2_00 nonlinear bias in P02_ss[mu4]',
                     'b2_00_c' : 'the b2_00 nonlinear bias in (P11_ss+P02_ss)[mu2]',
                     'b2_00_d' : 'the b2_00 nonlinear bias in (P13_ss+P22_ss+P04_ss)[mu4]',
                     'b2_01_a' : 'the b2_01 nonlinear bias in P01_ss[mu2]',
                     'b2_01_b' : 'the b2_01 nonlinear bias in (P12_ss+P03_ss)[mu4]'
                    }
