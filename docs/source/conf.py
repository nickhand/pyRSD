...
project = u'pyRSD'
copyright = u'2015-2017, Nick Hand '
author = u'Nick Hand'
...
latex_documents = [
  (master_doc, 'pyRSD.tex', u'pyRSD Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pyRSD', u'pyRSD Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pyRSD', u'pyRSD Documentation',
   author, 'pyRSD', 'One line description of project.',
   'Miscellaneous'),
]
