...
class Transfer(object):
    """
    A class to deal with different transfer functions and their routines.
    ...
    def __init__(self, z=0., k=None, transfer_fit='EH',
        ...
        if "default" not in kwargs:
            kwargs["default"] = "Planck1_lens_WP_highL"
